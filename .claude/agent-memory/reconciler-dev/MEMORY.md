...
- [Unverified Paper image contract](project_unverified-paper-image-contract.md) — the in-container commands and env names nothing has ever actually run.
...
- [Integration freeze](project_integration-freeze.md) — the loop stalls ~60s into a real containerd run, right after a node call fails. Open.
