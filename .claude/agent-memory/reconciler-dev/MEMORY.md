...
- [Flapping escalation](project_flapping-escalation.md) — closed by a ledger plus an age gate; a count is not a duration, why `startedAt` was not the anchor, the neutral-pass traps.
