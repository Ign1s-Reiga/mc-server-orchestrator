...
- [Standing test instruments](store-test-instruments.md) — the legacy-row field sweep, why it parses toString instead of reflecting, and the class it cannot catch.
